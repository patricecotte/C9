 ...
 * <pre>
 **/
public class C9FontChooser extends JComponent
{
    // class variables
    /**
    ...
    private static C9FontChooser c9fcc = null;		// refrence to this instance of font chooser
    ...
    private C9Screen c9s;							// For Screen properties

    /**
     * Constructs a <code>C9FontChooser</code> object.
     **/
    public C9FontChooser()
    {
    ...
    /**
     * Constructs a <code>C9FontChooser</code> object using the given font size array.
     * @param fontSizeStrings  the array of font size string.
     **/
    public C9FontChooser(String[] fontSizeStrings)
    {
        ...
        contentsPanel.add(getSampleTextField(), BorderLayout.SOUTH);
        ...
        C9Screen currc9s = C9View.getC9scrn_prop();
        if (currc9s != null) this.setSelectedFont(currc9s.font);
    }

    /**
     *  Getters and Setters of the Font
     */
    ...
    // Use a text box instead of a panel
    ...
    /** <b>C9FontChooserRun		Runnable for external calls</b>
     * <ul></ul>
     */
    public class C9FontChooserRun implements Runnable {
    	 
    	// Default contstructor
        public C9FontChooserRun(){ }
    ...
    /** <b>	Main entry point for standalone execution </b>
     * 
     * @param args
     */
    public static void main(String[] args)  {
    	  ...
    	  if (c9fcc == null) {
    		  c9fcc = new C9FontChooser();		  
    	  }
    	  
   	 	  int result = c9fcc.showDialog(c9fcc);
    	  if (result == C9FontChooser.OK_OPTION)
    	     {
    	        Font font = c9fcc.getSelectedFont(); 
    	        C9Skinner.setNewc9sFont(font);
    	        // Force size to 18 becasue txtSample is not resizable
    	        C9Skinner.txtSample.setFont(new Font(font.getName(),font.getStyle(),18));
    	     } 	
   	  
    	  
    }
    
} // End of C9FontChooser source